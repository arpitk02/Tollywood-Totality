			...
			<main class="main-content">
				<div class="container">
					<div class="page">
						...
						<div class="row">
							<div class="col-md-4">
								<figure><img src="dummy/figure.png" alt="figure image"></figure>
							</div>
							<div class="col-md-8">
								<p class="leading">Tollywood Totality</p>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="team">
									<figure class="team-image"><img src="images/people.png" alt=""></figure>
									<h2 class="team-name">Taruni </h2>
							...
							<div class="col-md-4">
								<div class="team">
									<figure class="team-image"><img src="images/arpit.jpg" alt=""></figure>
									<h2 class="team-name">Arpit </h2>
									<small class="team-title"></small>
									<div class="social-links">
										<a href="https://www.linkedin.com/in/ak0201/" target="_blank" class="facebook"><i class="fa fa-linkedin"></i></a>
										<a href="https://www.facebook.com/Arpitk852" target="_blank" class="twitter"><i class="fa fa-facebook"></i></a>
										<a href="https://www.instagram.com/being_arpitk" target="_blank" class="google-plus"><i class="fa fa-instagram"></i></a>
									</div>
								</div>
							</div>
							<div class="col-md-4">
